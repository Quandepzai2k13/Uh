...
screenGui.Name = "rrdwanuifbhu9wdbu9pabu9dwabui9pdwbu9abu9wd"
...
local stealBtn = createModernButton(mainContent, "💰 STEAL Brainrot (works randomly)", UDim2.new(0, 0, 0, 0))
local floatBtn = createModernButton(mainContent, "☁️ FLOAT", UDim2.new(0, 0, 0, 50))
...
creditsLabel.Text = "🔥 Credits By Quan"
